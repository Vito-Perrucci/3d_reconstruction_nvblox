...
echo "================================================="
echo "   REAL DATA RECONSTRUCTION (Vicon + NVBLOX) "
echo "================================================="
...
# This starts RViz, NVBlox, and Vicon configured for bag data
echo "--> Launching NVBlox with Vicon (Real Data Mode)..."
ros2 launch tizio_bot launch_real_robot_vicon.launch.py \
    data_source:=bag \
    voxel_size:=0.05 &
